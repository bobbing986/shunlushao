...
<h5>I. YerShop使用许可的权利、约束与限制</h5>
 ...
 <p>4. 获得授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持期限、技术支持方式和技术支持内容，自授权时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。</p>
 <p>5. 如果您在您的程序中引用yershop功能或者设计，请在明显的地方如官网等地方加入本设计或功能采用yershop。 </p>
 <p>6. 不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。 </p>
 <p>7. 无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 YerShop的整体或任何部分，未经书面许可，网站页面页脚处的 YerShop名称和上yershop公司下属网站(http://www.yershop.com) 的链接都必须保留，而不能清除或修改 </p>
 <p>8. 禁止在 YerShop的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p> 
 <p>9. 如果您未能遵守本协议的条款，您的免使用授权将被终止，所被许可的权利将被收回，并承担相应法律责任。 
</p>
