...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            name: '占比',
            data: [
                ['退货<?php echo ($back); ?>元 ',   <?php echo ($b); ?>],
                ['换货<?php echo ($change); ?>元 ',      <?php echo ($c); ?>],
				 ['申请取消<?php echo ($cancel); ?>元 ',      <?php echo ($d); ?>],
                {
                    name: '销售额<?php echo ($total); ?>元 ',
                    y: <?php echo ($a); ?>,
                    sliced: true,
                    selected: true
                },
...
<p style="height:30px;margin:10px;color:deeppink;font-size:16px">利润：<?php echo ((isset($total) && ($total !== ""))?($total):"0"); ?>-<?php echo ((isset($back) && ($back !== ""))?($back):"0"); ?>-<?php echo ((isset($change) && ($change !== ""))?($change):"0"); ?>-<?php echo ((isset($cancel) && ($cancel !== ""))?($cancel):"0"); ?>=<?php echo ((isset($profits) && ($profits !== ""))?($profits):"0"); ?>元</p>
<table id="datatable">
	<thead>
		<tr>
			<th></th>
	...
	<tbody>
		<tr>
			...
			<td><?php echo ($total); ?></td>
             <td><?php echo ($salenum); ?>件</td>
			 <td><?php echo ($salecount); ?>种</td>
		</tr>
		<tr>
			<th>退货</th>
			<td><?php echo ($back); ?></td>
			<td><?php echo ($backnum); ?>件</td>
			<td><?php echo ($backcount); ?>种</td>
		</tr>
		<tr>
			<th>换货</th>
			<td><?php echo ($change); ?></td>
			<td><?php echo ($changenum); ?>件</td>
			<td><?php echo ($changecount); ?>种</td>

		</tr>
		<tr>
			<th>申请取消</th>
			<td><?php echo ($cancel); ?></td>
			<td><?php echo ($cancelnum); ?>件</td>
			<td><?php echo ($cancelcount); ?>种</td>
