...
<div class="main-title">
		<h2><?php echo ($meta_title); ?>[ <strong>全部数量</strong>(<?php echo get_Ordernum($status,'Area'); ?>)]</h2>
	</div>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Area/index','&cate_id='.$cate_id,false);?>"><i class="btn-search"></i></a>
			</div>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>"></td>
						...
						<td><a title="编辑" href="<?php echo U('edit?id='.$vo['id'].'&pid='.$pid);?>"><?php echo ($vo["area"]); ?></a></td>
...
<script status="text/javascript">
    ...
    $('#time-end').datetimepicker({
	    ...
	    autoclose:true
            ...
            //导航高亮
            highlight_subnav('<?php echo U('Area/index');?>');
